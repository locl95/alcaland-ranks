...
export function CharacterLadder({characters, cachedCharacters}: Readonly<CharacterLadderProps>) {
    const [isLadderOpen, setIsLadderOpen] = useState(true);
    const [expandedCharacters, setExpandedCharacters] = useState<Set<string>>(new Set());

    const sortedCharacters = [...characters].sort((a, b) => b.score - a.score);
    const sortedCachedCharacters = [...cachedCharacters].sort((a, b) => b.score - a.score);
            ...
            {isLadderOpen && (
                <div className="ladder-content">
                    {sortedCharacters.map((character, index) => {
                        ...
                        const cachedRaiderIoProfile = getCachedRaiderIoProfile(cachedCharacters, character);
