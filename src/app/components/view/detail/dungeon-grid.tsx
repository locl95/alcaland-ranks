import {MythicPlusRun, RaiderioProfile, Season} from "@/app/utils/raiderio.ts";
...
export function DungeonGrid({raiderioProfiles, raiderioCachedProfiles, season}: DungeonGridProps) {
