...
describe('RealmSelect', () => {
  it('calls onRegionChange with the new region value', async () => {
    ...
    render(
      <RealmSelect region="eu" realm="" onRegionChange={onRegionChange} onRealmChange={vi.fn()} />,
    );
  ...
  it('calls onRealmChange when a realm is selected', async () => {
    const onRealmChange = vi.fn();
    render(
      <RealmSelect region="eu" realm="" onRegionChange={vi.fn()} onRealmChange={onRealmChange} />,
    );
  ...
  it('shows NA realms when region is us', () => {
    render(<RealmSelect region="us" realm="" onRegionChange={vi.fn()} onRealmChange={vi.fn()} />);
